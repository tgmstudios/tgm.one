...
import { SourceMapConsumer } from 'file:///workspace/node_modules/nitropack/node_modules/source-map/source-map.js';
...
const _Y5rWMrV7z3Y6sJQmpdYAWrn7QqDkOmmo0H0Bn6rshY = (function(nitro) {
...
const plugins = [
  _Y5rWMrV7z3Y6sJQmpdYAWrn7QqDkOmmo0H0Bn6rshY,
...
const ____path_ = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const status = ((_a = err == null ? void 0 : err.response) == null ? void 0 : _a.status) || 500;
    setResponseStatus(event, status);
    return { error: true, message: (err == null ? void 0 : err.message) || "Proxy error" };
  }
});
