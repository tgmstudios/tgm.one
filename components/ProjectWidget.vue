    ...
    <div v-if="project">
        <div v-if="view === 'card'" class="group bg-white/5 hover:bg-white/10 transition rounded-xl p-4 shadow-sm hover:shadow-md h-full">
            <router-link :to="project.path" class="flex flex-col h-full">
                <div class="flex items-center gap-3 mb-3">
                    <img :src="project.icon" alt="Project Image" class="h-10 w-10 rounded-md object-contain bg-white/10" />
        ...
        <div v-else>
            <div v-if="showHeader">
                ...
                <img :src="project.icon" alt="Project Image" class="h-16 w-16 rounded-md object-contain bg-white/10 mb-4">
